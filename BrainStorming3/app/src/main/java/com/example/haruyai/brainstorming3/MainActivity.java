...
public class MainActivity extends AppCompatActivity {
    ...
    //HTTP通信用
    String action_keyword = "http://fullfill.sakura.ne.jp/JPHACKS/action_keyword.php";
    ...
    //ノードに表示するためのとりあえずの文字列
    private String[] kotoba_array = {
            "言葉2", "言葉3", "言葉4", "言葉5", "言葉6", "言葉7",
            "言葉8", "言葉9", "言葉10", "言葉11", "言葉12", "言葉13",
            "言葉14", "言葉15", "言葉16", "言葉17", "言葉18", "言葉19",
            "言葉20", "言葉21", "言葉22", "言葉23", "言葉24", "言葉25",
            "言葉26", "言葉27", "言葉28", "言葉29", "言葉30", "言葉31",
            "言葉32", "言葉33", "言葉34", "言葉35", "言葉36", "言葉37"
    };
    ...
    private List<String> defaultWords_List = new ArrayList<String>();
    //オリジナルノードのもつ文字を格納するリスト（個数は可変なのでpathNhowmanyOriginals_Mapで参照するが、作成されていない箇所は空文字で対応する）
    private List<String> originalWords_List = new ArrayList<String>();
    ...
    private class GetDefaultNodesWords extends AsyncTask<String, Void, String>{
        @Override
        protected String doInBackground(String[] params){
            try {
                HttpClient httpclient = new DefaultHttpClient(null);
                HttpPost httppost = new HttpPost("http://fullfill.sakura.ne.jp/JPHACKS/action_keyword.php");

                // Request parameters and other properties.
                List<NameValuePair> param = new ArrayList<>(1);
                param.add(new BasicNameValuePair("keyword", whatsDefault));
    ...
    public void centerButtonClicked(){
        ...
        if(pathDefault_List.indexOf(follower) == -1) {
            ...
            for (int j=0; j<perNode; j++) {
                ...
                System.out.println(defaultNodesishere[j]);
                //System.out.println(defaultNodesishere[j].getClass());
            }
            //textsOnbuttons_array[0].setText("a");
            //textsOnbuttons_array[1].setText("b");
            //textsOnbuttons_array[2].setText("c");
            Toast.makeText(this, defaultNodesishere[1], Toast.LENGTH_SHORT).show();
